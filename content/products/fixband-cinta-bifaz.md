---
name: FIXBAND CINTA BIFAZ
description: La unión práctica y resistente para todo tipo de superficies
globals:
  order: 7
  productImage: images/cinta-bifaz.jpg
  logo: images/fixband-cinta-bifaz.jpg
page:
  - type: hero
    slogan: La unión práctica y resistente para todo tipo de superficies
    heroImage:
  ...
  - type: details
    ...
    function:
      - text: Fija y une superficies de manera segura
      - text: Soporte de espuma para mejor adaptación
    application:
      - text: Para uniones generales donde se requiera cinta de doble faz con soporte de
          espuma.
    presentation:
      - text: "Espesor: 1,5 mm"
      - text: "Ancho: 12 mm y 24 mm"
      - text: "Largo: 5 m y 10 m"
    detailsImage: images/tom_62137_3_2.webp
  - type: benefits
